...
/**
 * To install it simple put:
 *
 * https://github.com/facebook/facebook-php-sdk
 *
 * into your library path under the name `facebook`
 */
...
if (!defined('FACEBOOK_LIBRARY_PATH')) {
	...
	define('FACEBOOK_LIBRARY_PATH', $path . '/src');
}
